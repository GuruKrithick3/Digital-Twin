      ...
      <div className="flex items-center justify-between shrink-0">
        <div>
          <div className="flex items-center space-x-3">
            <h2 className="text-2xl font-bold text-white font-heading tracking-wide">Bharati Station Digital Twin</h2>
            <span className="px-2.5 py-0.5 rounded text-[10px] font-bold font-mono uppercase bg-emerald-500/15 text-emerald-400 border border-emerald-500/30">
              OPERATIONAL
            </span>
          </div>
          <p className="text-xs text-slate-400 font-sans mt-0.5">69°24'24" S, 76°11'42" E • Larsemann Hills, East Antarctica</p>
        </div>
      </div>
