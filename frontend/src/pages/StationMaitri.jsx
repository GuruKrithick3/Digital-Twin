      ...
      <div className="flex items-center justify-between shrink-0">
        <div>
          <div className="flex items-center space-x-3">
            <h2 className="text-2xl font-bold text-white font-heading tracking-wide">Maitri Station Digital Twin</h2>
            <span className="px-2.5 py-0.5 rounded text-[10px] font-bold font-mono uppercase bg-amber-500/15 text-amber-400 border border-amber-500/30">
              WARNING STATUS
            </span>
          </div>
          <p className="text-xs text-slate-400 font-sans mt-0.5">70°45'57" S, 11°44'00" E • Schirmacher Oasis, Queen Maud Land</p>
        </div>
      </div>
